  ...
  return (
    <div className="dashboard" data-testid="dashboard-page">
      ...
      <div className="dash-header">
        <div>
          ...
          <h1 className="dash-greeting">
            {greeting()},{' '}
            <span className="dash-name">{user?.name || 'there'}</span>
          </h1>
        </div>
        <button
          onClick={logout}
      ...
      >
        <motion.div
          variants={fadeUp}
          className="stat-card stat-tasks"
        ...
        >
          ...
          <div className="stat-value">
            ...
            <span className="stat-total">/{stats?.total_tasks || 0}</span>
          </div>
        ...
        <motion.div
          variants={fadeUp}
          className="stat-card stat-habits"
        ...
        >
          ...
          <div className="stat-value">
            {stats?.habits_done || 0}
            <span className="stat-total">/{stats?.total_habits || 0}</span>
          </div>
        ...
        <motion.div
          variants={fadeUp}
          className="stat-card stat-focus"
        ...
        <motion.div
          variants={fadeUp}
          className="stat-card stat-sessions"
          onClick={() => navigate('/timer')}
      ...
      >
        <p className="overline" style={{ padding: '0 24px', marginBottom: 12 }}>
          Quick Actions
        </p>
        {[
          {
      ...
      <style>{`
        ...
        .dash-name {
          background: linear-gradient(135deg, #ffffff, #00FFB2);
        ...
        .stat-icon-cyan { background: rgba(0,229,255,0.1); color: #ffffff; }
